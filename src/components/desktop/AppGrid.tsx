...
interface AppGridProps {
  apps: SearchableItem[];
  onAppClick: (app: SearchableItem) => void;
}
...
export const AppGrid: React.FC<AppGridProps> = ({ apps, onAppClick }) => {
  ...
  const getIconComponent = (iconName?: string) => {
    ...
    return iconMap[iconName || 'folder'] || iconMap.folder;
  };
    ...
    <div className="grid grid-cols-4 gap-3">
      {apps.map((app, index) => (
        <motion.button
          ...
          className={`flex flex-col items-center p-3 rounded-lg transition-colors focus:outline-none focus:ring-2 focus:ring-blue-500 ${
            isDark
